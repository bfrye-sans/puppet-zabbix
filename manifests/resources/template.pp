...
define zabbix::resources::template (
  ...
  Boolean $delete_missing_host_groups     = false,
  Boolean $delete_missing_template_groups = false,
  Boolean $delete_missing_hosts           = false,
  Boolean $delete_missing_httptests       = false,
  Boolean $delete_missing_items           = false,
  Boolean $delete_missing_mediatypes      = false,
  ...
  @@zabbix_template { $template_name:
    ...
    delete_missing_host_groups     => $delete_missing_host_groups,
    delete_missing_template_groups => $delete_missing_template_groups,
    delete_missing_hosts           => $delete_missing_hosts,
    delete_missing_httptests       => $delete_missing_httptests,
    delete_missing_items           => $delete_missing_items,
    delete_missing_mediatypes      => $delete_missing_mediatypes,
